  ...
  <div class="bg-white dark:bg-zinc-800 sticky top-0 left-0 w-full z-10">
    ...
    >
      ...
      <li
        ...
        class="shrink-0 px-1.5 py-0 z-10 duration-200 last:mr-4  dark:hover:text-zinc-500 
        text-base font-bold h-4 leading-4 cursor-pointer hover:bg-zinc-200 dark:hover:bg-zinc-900 rounded mr-1 mb-1"
        :class="{'text-zinc-900 dark:text-zinc-300 bg-zinc-200 dark:bg-zinc-900': currentCategoryIndex === index}"
      >
        {{ item.name }}
      </li>
    </ul>
